...
import { useAddBrandsMutation, useAddCategoryMutation } from "../redux/api/categoryApi";
...
const AddBrands = ({ openAddModal, setOpenAddModal }) => {
  ...
  const handleSubmit = async (values) => {
    ...
    try {
      ...
      const res = await addBrands(formData);
      console.log(res);
  ...
  return (
    ...
    >
      <div className="mb-20 mt-4">
        <div>
          <div className="font-bold text-center mb-11">+ Add Brands</div>
